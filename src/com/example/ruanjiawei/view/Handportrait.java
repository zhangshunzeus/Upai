package com.example.ruanjiawei.view;
...
public class Handportrait extends ImageView {
	...
	public Handportrait(Context context) {
		super(context);

		init();
	}

	public Handportrait(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public Handportrait(Context context, AttributeSet attrs, int defStyle) {
	...
	private void setup() {
		...
		// 计算圆形带边界部分的最小半径
		mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 3,
				(mBorderRect.width() - mBorderWidth) / 3);
